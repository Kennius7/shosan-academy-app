...
const Hero = () => {
    ...
    return (
        <section className="w-full relative sm:h-[600px] xs:h-[500px] h-[400px]">
            ...
            <div className="absolute top-32 z-[2] w-full flexColCenter md:mb-[4%] sm:mb-[3%] xs:mb-[4%] mb-[3%]">
                ...
                <div className="flexCenter bg-primaryBlue rounded-[10px] border-[2px] 
                    ...
                    <div className="font-sans font-bold text-white sm:text-[22px] xs:text-[20px] text-[16px] 
                        tracking-wider">
                        Offer Lasts Till
                    </div>
                </div>
